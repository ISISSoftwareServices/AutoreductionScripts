...
variable_help = {
    'standard_vars' : {
        ...
        'input_mode' : "Choose an input mode, Summed or Individual",
        'mode' : "The mode, PDF or Rietveld or left blank to determine value from the sample logs",
        'multiple_scattering' : "Do you want multiple scattering on?"
    },
}