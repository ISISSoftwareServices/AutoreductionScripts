...
sys.path.append("/isis/NDXLET/user/scripts/autoreduction") 


from LETReduction import LETReduction
...
##### Here one sets up folders where to find input data and where to save results ####
    ...
    input_file=r'd:\Data\Mantid_Testing\15_10\LET00024374.nxs'
    output_dir=r'd:\Data\Mantid_Testing\15_10'
