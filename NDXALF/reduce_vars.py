standard_vars = {
         'energy_bins':[-0.1, 0.0025, 0.8],
         'incident_energy':'AUTO',
         'sum_runs':False,
         'monovan_run':None,
         'wb_run':24363,
         'sample_run':[24374, 24375]
}
advanced_vars={
         'load_monitors_with_workspace':False,
        'monovan_hi_frac':0.4,
        'hardmaskOnly':'hard_153.msk',
        'detector_van_range':[4.8, 5.2],
        'vanadium-mass':8.47,
        'background_range':[90000, 99000],
        'save_format':'nxspe',
        'norm_method':'current',
        'det_cal_file':'det_corrected_cycle153.dat',
        'monovan_lo_frac':-0.4,
        'monovan_mapfile':'LET_rings_153.map',
        'bleed_maxrate':0.005,
        'data_file_ext':'.nxs',
        'motor_offset':None,
        'check_background':True,
        'bleed':False,
        'map_file':'LET_one2one_153.map'
}
variable_help={
         'standard_vars' : {
